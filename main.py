...
h = InlineKeyboardButton("1⃣ Страница", web_app=WebhookInfo(url = "https://kruzarium.webu.repl.co"))
h2 = InlineKeyboardButton("Страница 2⃣", web_app=WebhookInfo(url = "https://kruzarium.webu.repl.co/projects.html"))
